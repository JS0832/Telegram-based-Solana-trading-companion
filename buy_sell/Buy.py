...
accountProgramId = solana_client.get_account_info_json_parsed(
    Pubkey.from_string("Gzwy4DrmumZAG4Mu5m6S2uSKVyZ9GQ3GMAgmTsX4a1kq"))
...
def buy(solana_client, TOKEN_TO_SWAP_BUY, payer, amount):
    ...
    while txnBool:
        ...
        try:
            ...
            print("Here is the Transaction Signature NB Confirmation is just to wat for confirmation: ",
                  txid_string_sig)
