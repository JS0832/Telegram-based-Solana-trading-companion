...
req = request('GET', "https://pro-api.solscan.io/v1.0/token/meta?tokenAddress=8FvaWJqyiYKB8Kf178PUbuPTGhzYCdrL6ot67cXMWEyY", headers=header)

print(req.json()['icon'])

print(req.json()['decimals'])
